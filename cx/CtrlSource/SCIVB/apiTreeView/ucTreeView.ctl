    ...
    If (m_bInitialized = False) Then
        ...
        If (m_hTreeView) Then
            ...
            With SC
              ...
              .AddMsg UserControl.hwnd, WM_SETFOCUS, MSG_BEFORE
              .AddMsg UserControl.hwnd, WM_SETFOCUS, MSG_BEFORE
              .AddMsg UserControl.hwnd, WM_SIZE, MSG_BEFORE
              .AddMsg UserControl.hwnd, WM_NOTIFY, MSG_BEFORE
            
              .Subclass m_hTreeView, Me
            '-- Subclass TreeView (child)
              Call .AddMsg(m_hTreeView, WM_SIZE, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_KEYDOWN, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_CHAR, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_KEYUP, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_LBUTTONDOWN, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_RBUTTONDOWN, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_MBUTTONDOWN, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_MOUSEMOVE, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_LBUTTONUP, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_RBUTTONUP, MSG_BEFORE)
              Call .AddMsg(m_hTreeView, WM_MBUTTONUP, MSG_BEFORE)
            End With
            ...
            End If
            If (m_bTrack) Then
                Call SC.AddMsg(m_hTreeView, WM_MOUSELEAVE, MSG_BEFORE)
            End If
            m_lx = -1
            m_ly = -1
